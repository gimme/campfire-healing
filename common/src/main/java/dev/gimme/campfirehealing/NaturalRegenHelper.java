...
public class NaturalRegenHelper {
    ...
    public static float getRegenTicks() {
        float regenSpeedMultiplier = ServerConfig.INSTANCE.getNaturalRegenSpeedMultiplier();
    ...
    public static boolean isModFeatureDisabled() {
        return ServerConfig.INSTANCE.getNaturalRegenSpeedMultiplier() < 0;
    }
    ...
    public static boolean isRegenStopped(ServerPlayer player) {
        float maxHealToPercentage = ServerConfig.INSTANCE.getNaturalRegenMaxHealToPercentage();
